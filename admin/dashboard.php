...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="stats-card" onclick="window.location.href='verify_artisans.php'">
                    <div class="icon" style="color: var(--accent-color);">
                        <i class="fas fa-hammer"></i>
                    </div>
                    <div class="number" style="color: var(--accent-color);" id="totalArtisans">-</div>
                    <div class="label">Artisans</div>
                </div>
            </div>
        </div>
